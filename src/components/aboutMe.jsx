             ...
             <section id="skills">
              <div className="skills-grid">
               <div className="container-skills" >
                ...
                <p>I'm a full stack developer. The main area of interest is back end development.</p>
                <p>Information Security & quality assurance testing.</p>
                <p>I'm a Cybersecurity enthusiast, so I like protecting my projects to real world threats.</p>
              ...
              <div className="skills-animation">
               <h3>Here goes the technologies</h3>
